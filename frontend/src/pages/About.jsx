...
const OrganicThemeStyles = () => (
  <style>{`
    ...
    .of-fade-up {
      animation: of-fade-up 0.7s cubic-bezier(0.16, 1, 0.3, 1) both;
    }

    .of-underline {
      background-image: linear-gradient(120deg, rgba(4,120,87,0.18) 0%, rgba(4,120,87,0.18) 100%);
    ...
    <div className="of-root of-grain-bg min-h-screen selection:bg-emerald-100 selection:text-emerald-900 overflow-hidden">
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 border-b border-stone-200/60">
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          <div className="of-fade-up inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 text-emerald-800 text-xs font-semibold uppercase tracking-wider mb-6">
            <Sprout size={14} /> Cultivating the Future
          </div>

          <h1 className="of-fade-up of-serif text-4xl md:text-6xl font-medium text-stone-900 tracking-tight max-w-4xl mx-auto leading-[1.15]" style={{ animationDelay: "0.05s" }}>
            Bridging the gap between{" "}
            <span className="italic text-emerald-800 font-serif of-underline">honest farming</span> and
            intelligent technology.
          </h1>

          <p className="of-fade-up mt-8 max-w-2xl mx-auto text-base md:text-lg text-stone-600 leading-relaxed" style={{ animationDelay: "0.1s" }}>
          ...
          {/* Stats row */}
          <div className="of-fade-up mt-14 grid grid-cols-3 gap-4 max-w-xl mx-auto" style={{ animationDelay: "0.15s" }}>
            {stats.map((stat) => (
              <div key={stat.label} className="px-2">
                <div className="of-serif text-2xl md:text-3xl font-medium text-emerald-800">
                  {stat.value}
                </div>
                <div className="text-[11px] md:text-xs text-stone-500 mt-1 leading-snug">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-8">
              ...
              <div className="relative p-6 bg-emerald-900 text-stone-100 rounded-2xl shadow-[0_20px_45px_-20px_rgba(6,78,59,0.55)] overflow-hidden">
                <Sparkles className="absolute -top-3 -right-3 text-emerald-700/40" size={72} />
                <Users className="text-amber-400 mb-4 relative z-10" size={32} />
                <h4 className="of-serif text-xl font-medium mb-2 text-white relative z-10">
                  The Direct Loop
                </h4>
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
              <div className="group p-8 bg-white border border-stone-200/80 rounded-2xl transition-all duration-300 hover:border-amber-300/70 hover:shadow-[0_16px_36px_-20px_rgba(45,58,47,0.15)] hover:-translate-y-0.5">
                <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center text-amber-800 mb-6 transition-transform duration-300 group-hover:scale-110">
                  <ShieldCheck size={20} />
                </div>
              ...
              <div className="group p-8 bg-white border border-stone-200/80 rounded-2xl sm:translate-y-6 transition-all duration-300 hover:border-emerald-300/70 hover:shadow-[0_16px_36px_-20px_rgba(45,58,47,0.15)] hover:-translate-y-0.5">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-800 mb-6 transition-transform duration-300 group-hover:scale-110">
                  <Leaf size={20} />
                </div>
              ...
              <div className="group p-8 bg-white border border-stone-200/80 rounded-2xl transition-all duration-300 hover:border-emerald-300/70 hover:shadow-[0_16px_36px_-20px_rgba(45,58,47,0.15)] hover:-translate-y-0.5">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-800 mb-6 transition-transform duration-300 group-hover:scale-110">
                  <Bot size={20} />
                </div>
              ...
              <div className="group p-8 bg-white border border-stone-200/80 rounded-2xl sm:translate-y-6 transition-all duration-300 hover:border-amber-300/70 hover:shadow-[0_16px_36px_-20px_rgba(45,58,47,0.15)] hover:-translate-y-0.5">
                <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center text-amber-800 mb-6 transition-transform duration-300 group-hover:scale-110">
                  <Globe size={20} />
                </div>
      ...
      <section className="py-20 md:py-28 max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feat, index) => (
            <div
              key={index}
              className="group p-8 bg-white border border-stone-200/70 hover:border-emerald-600/30 rounded-2xl transition-all duration-300 hover:shadow-[0_12px_30px_-15px_rgba(45,58,47,0.1)] hover:-translate-y-0.5 flex gap-6 items-start"
            >
              ...
              <div>
                <h3 className="font-semibold text-stone-900 text-lg mb-2 flex items-center gap-1">
                  ...
                  <ArrowUpRight
                    size={16}
                    className="opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all text-stone-400"
                  />
                </h3>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 items-center">
            <div className="md:col-span-1">
              <h3 className="of-serif text-2xl font-medium text-stone-950">
            ...
            <div className="md:col-span-2 flex flex-wrap gap-2 md:justify-end">
              {techStack.map((tech) => (
                <span
                  key={tech}
                  className="px-4 py-2 bg-white border border-stone-200 text-stone-700 rounded-lg text-xs font-medium hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-900 transition-all cursor-default"
                >
                  {tech}
                </span>
              ))}
