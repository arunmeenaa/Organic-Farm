...
"
      >
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-4xl font-black">{order.title}</h1>

            <p className="mt-2 text-gray-500">{order.category}</p>
          </div>
...
shadow-[0_8px_40px_rgba(0,0,0,0.12)]"
        >
          <h2 className="text-2xl font-bold mb-5">Provider</h2>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold">{order.seller.name}</h3>
              ...
              <p className="mt-2">{order.seller.email}</p>
            </div>
          </div>
        </div>
...
shadow-[0_8px_40px_rgba(0,0,0,0.12)]"
        >
          <h2 className="font-bold text-xl mb-5">Job Details</h2>
...
shadow-[0_8px_40px_rgba(0,0,0,0.12)]"
        >
          <h2 className="font-bold text-xl mb-6">Progress</h2>
      ...
      {order.status === "completed" && (
        <div className="mt-10 text-right">
          <button className="px-7 py-3 rounded-2xl bg-emerald-600 text-white font-semibold">
            Confirm Completion
          </button>
        </div>
      )}
